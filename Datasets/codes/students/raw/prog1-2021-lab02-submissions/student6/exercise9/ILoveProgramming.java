...
public class ILoveProgramming {
	...
	public static void main(String[] args) {
		...
		for (int iLoveProgrammingPrintCount = 0; iLoveProgrammingPrintCount <= 20; iLoveProgrammingPrintCount++) {
			// actually doing the printing
			System.out.println("I love programming!" + iLoveProgrammingPrintCount);
		}
	}
}