...
public class Crowdfunding {
	...
	public static void main(String[] args) {
		...
		//accepts inputs, then checks if the value is one of the predetermined quantities, otherwise returns an error message
		//if true, it checks what values it is higher than and prints the reward for that tier and all previous ones
