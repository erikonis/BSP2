package lu.uni.programming1.lab2.ex8;
...
public class Crowdfunding {
	...
	public static void main(String[] args) {
		...
		System.out.print("Please choose an amount to donate\n'Valid options are 10€, 20€, 50€, 100€, 200€, 500€': ");
		int donationMoney = scanner.nextInt();
		String rewards = "";
		switch (donationMoney) {
		case 500:
