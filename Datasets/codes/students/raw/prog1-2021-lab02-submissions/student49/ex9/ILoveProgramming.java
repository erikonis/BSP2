package lu.uni.programming1.lab2.ex9;
...
public class ILoveProgramming {
	...
	public static void main(String[] args) {
		...
		for (int iLoveProgrammingPrintCount = 0; iLoveProgrammingPrintCount <= numberOfiLoveProgrammingPrints; iLoveProgrammingPrintCount = iLoveProgrammingPrintCount
				+ 1)
			;
		{
