...
public class ILoveProgramming {
	...
	public static void main(String[] args) {
		...
		for (int iLoveProgrammingPrintCount = 0; iLoveProgrammingPrintCount <= numberOfiLoveProgrammingPrints; iLoveProgrammingPrintCount = iLoveProgrammingPrintCount+1){ //the ; was too much
