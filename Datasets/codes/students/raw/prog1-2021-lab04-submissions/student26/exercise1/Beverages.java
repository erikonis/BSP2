...
class Beverages {
    public static void main(String[] args) {
        ...
        if (menu == 1 || menu == 2) { // client ordered meat
            if (adult) {
                System.out.println("Red wine");
            } else {
                System.out.println("Cola");
            }
        }else if (menu == 3) { // client ordered pasta with tomato sauce
            if (adult) {
                System.out.println("White wine");
            } else {
                System.out.println("Lemonade");
            }
        } else if (menu == 4) { // client ordered pasta with cream sauce
            if (!adult) {
                System.out.println("Still Water");
            } else {
                System.out.println("Port wine");
            }
        }else if (5 == menu) { // client ordered a soup
