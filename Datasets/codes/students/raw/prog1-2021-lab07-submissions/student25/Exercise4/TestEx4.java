...
public class TestEx4 {
    public static void main(String[] args) {
        ...
        filter(list, new SeniorFilter());

        
    }

    private static void filter(Set<Person> list, Filter filter) {
