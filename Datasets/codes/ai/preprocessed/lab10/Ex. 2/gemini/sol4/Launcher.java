public class Launcher {
    public static void main(String[] args) {
        try {
            ...
            shinji.addComponent(new SanityComponent(100));
            shinji.addComponent(new HumanStartEffectComponent());
            shinji.addComponent(new HumanManeuverEffectComponent());
            ...
            System.out.println("--- Human Pilot and Eva Unit (Component-Based) ---");
            eva01.start();
            ...
            reiDummy.addComponent(new DummyStartEffectComponent());
            reiDummy.addComponent(new DummyManeuverEffectComponent());
            ...
            asuka.addComponent(new SanityComponent(100));
            asuka.addComponent(new HumanStartEffectComponent());
            asuka.addComponent(new HumanManeuverEffectComponent());
