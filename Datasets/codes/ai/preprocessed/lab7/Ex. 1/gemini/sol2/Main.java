...
public class Main {
    public static void main(String[] args) {
        ...
        missionActions.add(new RobotActions.GoForwardAction());

        // then left for 3 tiles
        missionActions.add(new RobotActions.GoLeftAction());
        missionActions.add(new RobotActions.GoLeftAction());
        missionActions.add(new RobotActions.GoLeftAction());

        // then forward for 1 to discover a rock
        missionActions.add(new RobotActions.GoForwardAction());
        missionActions.add(new RobotActions.PickRockAction());
        ...
        missionActions.add(new RobotActions.GoForwardAction());
        missionActions.add(new RobotActions.TakePhotoAction(true)); // High-resolution photo of alien

        // 1 tile forward is where alien exists. Going right 2 tile and forward 1 then left 1 and forward 1 reaches a finish.
        missionActions.add(new RobotActions.GoRightAction());
        missionActions.add(new RobotActions.GoRightAction());
        missionActions.add(new RobotActions.GoForwardAction());
        missionActions.add(new RobotActions.GoLeftAction());
        missionActions.add(new RobotActions.GoForwardAction()); // Reaches finish (according to path 1)
        ...
        alternativeActions.add(new RobotActions.GoForwardAction());
        alternativeActions.add(new RobotActions.GoLeftAction());
        alternativeActions.add(new RobotActions.GoLeftAction());
        alternativeActions.add(new RobotActions.GoLeftAction());
        alternativeActions.add(new RobotActions.GoForwardAction());
        alternativeActions.add(new RobotActions.PickRockAction());
        alternativeActions.add(new RobotActions.GoForwardAction());

        // 2) the right decision: you move 1 tile right
        alternativeActions.add(new RobotActions.GoRightAction());
        ...
        alternativeActions.add(new RobotActions.GoRightAction()); // Leads to dead end
        ...
        alternativeActions2.add(new RobotActions.GoForwardAction());
        alternativeActions2.add(new RobotActions.GoLeftAction());
        alternativeActions2.add(new RobotActions.GoLeftAction());
        alternativeActions2.add(new RobotActions.GoLeftAction());
        alternativeActions2.add(new RobotActions.GoForwardAction());
        alternativeActions2.add(new RobotActions.PickRockAction());
        alternativeActions2.add(new RobotActions.GoForwardAction());
        alternativeActions2.add(new RobotActions.GoRightAction()); // The right decision

        // 2.2) you go 1 tile back (up)
        alternativeActions2.add(new RobotActions.GoBackAction());

        // then 3 Right
        alternativeActions2.add(new RobotActions.GoRightAction());
        alternativeActions2.add(new RobotActions.GoRightAction());
        alternativeActions2.add(new RobotActions.GoRightAction());

        // 1 back
        alternativeActions2.add(new RobotActions.GoBackAction()); // Ends up in a dead end
