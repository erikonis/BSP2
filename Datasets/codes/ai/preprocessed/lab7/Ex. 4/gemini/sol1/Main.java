public class Main {
    public static void main(String[] args) {
        ...
        PersonFilterEngine engine = new PersonFilterEngine();
        ...
        Person[] lecturersRemoved = engine.applyFilter(people, lecturerFilter);
        ...
        Person[] seniorsRemovedFromLecturersRemoved = engine.applyFilter(lecturersRemoved, seniorFilter);
        ...
        Person[] juniorsRemoved = engine.applyFilter(people, juniorFilter);
        ...
        Person[] sequentialResult = engine.applySequentialFilters(people, lecturerFilter, seniorFilter);
