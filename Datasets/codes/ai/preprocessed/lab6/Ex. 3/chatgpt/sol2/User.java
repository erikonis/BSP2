...
public class User extends Profile implements Observer {
    ...
    @Override
    protected void notifyObservers(Post post) {
    ...
    public void update(Post post) {
        System.out.println("🔔 Notification for " + name + ": " + post.getAuthor().getName() + " posted: " + post.getContent());
    }
