public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Date nextDate = date3.advance();
            System.out.println("Date3 after advance: " + nextDate.format(false, "-"));

            //Demonstrate invalid date
            try {
        ...
        try {
            ...
            Time time2 = time1.tick();
            System.out.println("Time1 after tick: " + time2.format(false));
            Time time3 = time2.tick();
            System.out.println("New day? " + time3.getHours() == 0 && time3.getMinutes() == 0 && time3.getSeconds() == 0);
            System.out.println("Time1 after 2 ticks: " + time3.format(true));

            //Demonstrate invalid time
            try{
            ...
            // test equals and hashcode
            Time time4 = new Time(23, 59, 58);
            System.out.println("Time1 equals Time4: " + time1.equals(time4));
            System.out.println("Time1 hash code: " + time1.hashCode());
            System.out.println("Time4 hash code: " + time4.hashCode());
        ...
        try {
            ...
            DateTime nextDateTime = dateTime.tick();
            System.out.println("DateTime after tick 1:");
            nextDateTime.print(false, "-");

            DateTime nextDateTime2 = nextDateTime.tick();
            System.out.println("DateTime after tick 2:");
            nextDateTime2.print(false, "-");
